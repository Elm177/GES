...
?>
    <h1 class="mt-5" style="margin-top: -1rem !important;">Commande</h1>


    <!--button ajouter-->
    <a href="ajout_commande.php" class="btn btn-primary" style="float:right;margin-bottom:10px;">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16"> <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/></svg>
        ...
        $client=true;
       $sql="select * from commande where id_commande  in (select id_commande from ligne_commande) ";
    ...
    function confirmModife() {
        return confirm("Voulez-vous vraiment modifier ?");
                ...
                <a href="modif_commande.php?cmd=<?php echo $rs['id_commande']; ?>" class ="btn btn-success" id="getclient" onclick="return confirmModife()">
    ...
    function confirmDelete() {
        return confirm("Voulez-vous vraiment supprimer ?");
                ...
                <a href="supprimer_commande.php?cmd=<?php echo $rs['id_commande'] ; ?>" class="btn btn-danger"onclick="return confirmDelete()">
...
<script>
      var getclient = document.getElementById("getclient");
