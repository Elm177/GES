...
?>
    <h1 class="mt-5" style="margin-top: -1rem !important;">Client</h1>
    ...
    function confirmModife() {
        return confirm("Voulez-vous vraiment modifier ?");
                ...
                <a href="modifier_client.php?cd=<?php echo $rs['id_client']; ?>" class ="btn btn-success" onclick="return confirmModife()">
    ...
    function confirmDelete() {
        return confirm("Voulez-vous vraiment supprimer ?");
                ...
                <a href="supprimer_client.php?cd=<?php echo $rs['id_client']; ?>" class="btn btn-danger"onclick="return confirmDelete()">
